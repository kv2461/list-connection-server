...
const MobileTemplate = ({ setYogaPoseName, yogaPoseName, setListItem, listItem, listItems, listLogic, setData,  data, handleSearch, readyToSubmit, currentId, setCurrentId, genre, subgenre }) => {
