...
import { MusicNote, SelfImprovement, FitnessCenter, EggAlt } from '@mui/icons-material/'; //ShoppingBasket
  ...
  return (
    <Container maxWidth='md'>
        ...
        <StyledGrid container alignItems='stretch' spacing={3}>
            ...
            <ListTypeCards Icon={SelfImprovement} genre='Yoga' handleClick={()=>navigate('/createpost/yoga')}/>
